...
Data is stored in a module-level variable (not session_state) because
LangChain tools run in background threads without Streamlit context.
"""
...
def create_plotly_chart(
    ...
    Use this tool ONLY for the Streamlit app. For the React frontend, use create_react_chart instead.
