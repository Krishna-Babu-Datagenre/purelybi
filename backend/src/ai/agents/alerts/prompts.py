...
5. **Confirm**: Instruct the user to review the details in the preview card, make any desired edits, and click the 'Save Alert' button directly. You cannot save the alert yourself.
...
- Pick a `time_window` appropriate for the metric:
  - "yesterday", "last_24_hours", "today", "last_7_days"
- You MUST ask the user for an email address to notify if they haven't provided one.
...
>   Please review the preview card on the right, make any adjustments, and click 'Save Alert' to finalize.
"""
