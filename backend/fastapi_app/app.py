...
# Ensure local `sql-agent/` is on the import path so imports like
# `import streamchat...` resolve to `sql-agent/streamchat` at runtime.
_REPO_ROOT = Path(__file__).resolve().parents[1]
_SQL_AGENT_DIR = _REPO_ROOT / "sql-agent"
